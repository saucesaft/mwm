...
Bool
getpointer(const Drawable *win, int *x, int *y)
{
...
//			xcb_query_pointer(conn, *win), 0);
	...
	long unsigned int win_return, child_return;

	int root_x, root_y;

	unsigned int mask_return;
//                           1     2        3            4          5       6          7     8          9
	pointer = XQueryPointer(dpy, *win, &win_return, &child_return, &root_x, &root_y, &win_x, &win_y, &mask_return);
